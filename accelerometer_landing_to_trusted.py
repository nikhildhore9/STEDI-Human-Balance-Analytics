...
AccelerometerTrusted_node1702933173227 = glueContext.write_dynamic_frame.from_options(
    frame=DropFields_node1702933169560,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://udacity-glue-nikhil/accelerometer/trusted/",
        "compression": "snappy",
        "partitionKeys": [],
    },
    transformation_ctx="AccelerometerTrusted_node1702933173227",
)
